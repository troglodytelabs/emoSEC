...
# only collect a small sample (10 examples) to avoid memory issues
# use limit() before collect() to avoid loading everything into memory
sample_df = combined.select('text', 'labels', 'predictions', 'probabilities').limit(10)
